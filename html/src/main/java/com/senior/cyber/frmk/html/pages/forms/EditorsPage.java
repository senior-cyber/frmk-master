...
public class EditorsPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new BookmarkablePageLink<>("pages/search/simple.html", SimplePage.class));
        ...
        add(new BookmarkablePageLink<>("pages/tables/simple.html", com.senior.cyber.frmk.html.pages.tables.SimplePage.class));
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- summernote -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_SUMMER_NOTE)));
        // <!-- Google Font: Source Sans Pro -->
        response.render(CssHeaderItem.forUrl(AdminLTEResourceReference.CSS_GOOGLE_FONT));

        // <!-- CodeMirror -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_CODE_MIRROR)));
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_CODE_MIRROR_THEME_MONOKAI)));

        // <!-- CodeMirror -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_CODE_MIRROR)));
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_CODE_MIRROR_CSS)));
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_CODE_MIRROR_XML)));
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_CODE_MIRROR_HTML)));
