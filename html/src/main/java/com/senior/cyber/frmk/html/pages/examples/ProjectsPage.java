...
//        add(new Image("img_user_7", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_7)));
        ...
        add(new Image("img_avatar_1_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_1)));
        add(new Image("img_avatar_1_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_1)));
        add(new Image("img_avatar_1_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_1)));
        add(new Image("img_avatar_1_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_1)));
        add(new Image("img_avatar_1_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_1)));
        add(new Image("img_avatar_1_6", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_1)));
        add(new Image("img_avatar_1_7", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_1)));
        add(new Image("img_avatar_1_8", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_1)));
        add(new Image("img_avatar_2_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_2)));
        add(new Image("img_avatar_2_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_2)));
        add(new Image("img_avatar_2_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_2)));
        add(new Image("img_avatar_2_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_2)));
        add(new Image("img_avatar_2_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_2)));
        add(new Image("img_avatar_3_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_3)));
        add(new Image("img_avatar_3_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_3)));
        add(new Image("img_avatar_3_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_3)));
        add(new Image("img_avatar_3_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_3)));
        add(new Image("img_avatar_3_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_3)));
        add(new Image("img_avatar_3_6", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_3)));
        add(new Image("img_avatar_4_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_4)));
        add(new Image("img_avatar_4_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_4)));
        add(new Image("img_avatar_4_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_4)));
        add(new Image("img_avatar_4_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_4)));
        add(new Image("img_avatar_4_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_4)));
        add(new Image("img_avatar_4_6", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_4)));
        add(new Image("img_avatar_4_7", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_4)));
        add(new Image("img_avatar_5_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_5)));
        add(new Image("img_avatar_5_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_5)));
        add(new Image("img_avatar_5_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_AVATAR_5)));
