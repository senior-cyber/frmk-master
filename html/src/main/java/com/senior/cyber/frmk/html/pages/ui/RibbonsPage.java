...
public class RibbonsPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- Ion Slider -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_RANGE_SLIDER).getPath())));
        // <!-- Bootstrap slider -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_SLIDER_BOOTSTRAP).getPath())));
