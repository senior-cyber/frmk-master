...
public class WidgetsPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("img_user_1_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_6", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_7", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_8", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_9", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_10", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_11", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_12", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_13", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_14", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_15", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_16", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_17", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_18", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_19", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_1_20", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("img_user_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_2)));
        add(new Image("img_user_3_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_6", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_7", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_8", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_9", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_10", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_11", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_12", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_3_13", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("img_user_4_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_4)));
        add(new Image("img_user_4_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_4)));
        add(new Image("img_user_4_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_4)));
        add(new Image("img_user_4_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_4)));
        ...
        add(new Image("img_user_7_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_7)));
        add(new Image("img_user_7_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_7)));
        add(new Image("img_user_8", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("img_photo_1_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_1)));
        add(new Image("img_photo_1_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_1)));
        add(new Image("img_photo_2_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_2)));
        add(new Image("img_photo_2_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_2)));
        add(new Image("img_photo_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_3)));
    }
