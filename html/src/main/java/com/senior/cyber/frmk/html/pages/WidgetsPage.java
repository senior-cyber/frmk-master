...
public class WidgetsPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("user1-128x128.jpg_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_6", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_7", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_8", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_9", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_10", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_11", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_12", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_13", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_14", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_15", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_16", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        add(new Image("user1-128x128.jpg_17", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_1)));
        ...
        add(new Image("user3-128x128.jpg_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("user3-128x128.jpg_6", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("user3-128x128.jpg_7", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("user3-128x128.jpg_8", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("user3-128x128.jpg_9", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("user3-128x128.jpg_10", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("user3-128x128.jpg_11", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("user3-128x128.jpg_12", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        add(new Image("user3-128x128.jpg_13", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_3)));
        ...
        add(new Image("photo1.png_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_1)));
        add(new Image("photo1.png_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_1)));
        add(new Image("photo2.png_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_2)));
        add(new Image("photo2.png_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_2)));
        add(new Image("photo3.jpg_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_3)));
    }
