package com.senior.cyber.frmk.html.pages;
...
public class WidgetsPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("user1-128x128.jpg_5", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_6", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_7", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_8", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_9", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_10", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_11", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_12", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_13", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_14", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_15", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_16", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_17", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_18", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_19", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_20", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        add(new Image("user1-128x128.jpg_21", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_1).getPath())));
        ...
        add(new Image("user3-128x128.jpg_5", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_3).getPath())));
        add(new Image("user3-128x128.jpg_6", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_3).getPath())));
        add(new Image("user3-128x128.jpg_7", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_3).getPath())));
        add(new Image("user3-128x128.jpg_8", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_3).getPath())));
        add(new Image("user3-128x128.jpg_9", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_3).getPath())));
        add(new Image("user3-128x128.jpg_10", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_3).getPath())));
        add(new Image("user3-128x128.jpg_11", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_3).getPath())));
        add(new Image("user3-128x128.jpg_12", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_3).getPath())));
        add(new Image("user3-128x128.jpg_13", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_3).getPath())));
        add(new Image("user4-128x128.jpg_1", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_4).getPath())));
        add(new Image("user4-128x128.jpg_2", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_4).getPath())));
        add(new Image("user4-128x128.jpg_3", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_4).getPath())));
//         add(new Image("user4-128x128.jpg_4", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_4).getPath())));
        ...
        add(new Image("user7-128x128.jpg_2", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_7).getPath())));
        ...
        add(new Image("photo1.png_1", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PHOTO_1).getPath())));
        add(new Image("photo1.png_2", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PHOTO_1).getPath())));
        add(new Image("photo2.png_1", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PHOTO_2).getPath())));
        add(new Image("photo2.png_2", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PHOTO_2).getPath())));
        add(new Image("photo3.jpg_1", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PHOTO_3).getPath())));
    }
