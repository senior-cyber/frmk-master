...
public class TopNavSidebarPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(index3_2);
        BookmarkablePageLink<Void> index3_logo_1 = new BookmarkablePageLink<>("index3.html_logo_1", DashboardV3Page.class);
        add(index3_logo_1);
        BookmarkablePageLink<Void> index3_logo_2 = new BookmarkablePageLink<>("index3.html_logo_2", DashboardV3Page.class);
        add(index3_logo_2);
        ...
        index3_logo_1.add(new Image("img_logo", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_LOGO)));
        index3_logo_2.add(new Image("img_logo", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_LOGO)));
