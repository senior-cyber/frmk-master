...
public class ProfilePage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("img_photo_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_2)));
        add(new Image("img_photo_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_3)));
        add(new Image("img_photo_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PHOTO_4)));
    }
