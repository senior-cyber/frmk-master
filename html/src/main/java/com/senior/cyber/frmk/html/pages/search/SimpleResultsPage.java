...
public class SimpleResultsPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        WebMarkupContainer form = new WebMarkupContainer("simple-results.html_1");
        form.add(AttributeModifier.replace("action", urlFor(SimpleResultsPage.class, null).toString()));
        add(form);
