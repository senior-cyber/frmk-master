...
public class MailboxPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new BookmarkablePageLink<>("compose.html_2", ComposePage.class));
        add(new BookmarkablePageLink<>("read-mail.html_1", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_2", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_3", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_4", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_5", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_6", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_7", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_8", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_9", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_10", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_11", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_12", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_13", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_14", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_15", ReadMailPage.class));
        add(new BookmarkablePageLink<>("read-mail.html_16", ReadMailPage.class));
