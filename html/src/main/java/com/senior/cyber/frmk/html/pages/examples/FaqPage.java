...
public class FaqPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new BookmarkablePageLink<>("pages/examples/contact-us.html_1", ContactUsPage.class));
        add(new BookmarkablePageLink<>("pages/examples/contact-us.html_2", ContactUsPage.class));
        ...
        add(new BookmarkablePageLink<>("pages/examples/profile.html", FaqPage.class));
