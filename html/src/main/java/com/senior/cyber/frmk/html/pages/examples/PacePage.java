...
public class PacePage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        //  <!-- pace-progress -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_PACE_THEME_FLAT_TOP).getPath())));
        // <!-- Theme style -->
        ...
        // <!-- pace-progress -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_PACE).getPath())));
        // <!-- AdminLTE App -->
