...
public class CalendarPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- fullCalendar -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_FULL_CALENDAR_MAIN).getPath())));
        // <!-- Theme style -->
        ...
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_FULL_CALENDAR_MAIN).getPath())));
        try {
