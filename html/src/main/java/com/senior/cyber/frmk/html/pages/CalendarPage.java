...
public class CalendarPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- fullCalendar -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_FULL_CALENDAR_MAIN)));
        // <!-- Theme style -->
        ...
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_FULL_CALENDAR_MAIN)));
        try {
