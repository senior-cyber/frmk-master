...
public class ComposePage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new BookmarkablePageLink<>("pages/mailbox/mailbox.html_1", MailboxPage.class));
        add(new BookmarkablePageLink<>("pages/mailbox/mailbox.html_2", MailboxPage.class));
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        try {
            ...
            response.render(OnDomReadyHeaderItem.forScript(AdminLTEResourceReference.JS_SUMMER_NOTE_SCRIPT_1));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
