...
public class ValidationPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- jquery-validation -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_VALIDATION)));
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_METHOD)));
        // <!-- AdminLTE App -->
