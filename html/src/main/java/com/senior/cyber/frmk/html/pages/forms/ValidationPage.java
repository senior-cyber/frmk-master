...
public class ValidationPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- jquery-validation -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_VALIDATION).getPath())));
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_METHOD).getPath())));
        // <!-- AdminLTE App -->
