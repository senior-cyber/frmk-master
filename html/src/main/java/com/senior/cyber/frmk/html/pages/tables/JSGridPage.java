...
public class JSGridPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- jsGrid -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_JS_GRID).getPath())));
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_JS_GRID_THEME).getPath())));
        // <!-- Theme style -->
        ...
        // <!-- jsGrid -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_JS_GRID_DB).getPath())));
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_JS_GRID).getPath())));
        // <!-- AdminLTE App -->
