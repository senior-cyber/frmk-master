...
public class JSGridPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- jsGrid -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_JS_GRID)));
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_JS_GRID_THEME)));
        // <!-- Theme style -->
        ...
        // <!-- jsGrid -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_JS_GRID_DB)));
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_JS_GRID)));
        // <!-- AdminLTE App -->
