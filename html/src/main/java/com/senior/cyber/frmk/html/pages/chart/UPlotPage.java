...
public class UPlotPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new BookmarkablePageLink<>("chartjs.html_2", UPlotPage.class));
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_UPLOT).getPath())));
        ...
        // <!-- ChartJS -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_UPLOT).getPath())));
        // <!-- AdminLTE App -->
