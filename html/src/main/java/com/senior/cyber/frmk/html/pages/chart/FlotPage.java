...
public class FlotPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- FLOT CHARTS -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_JQUERY_FLOT).getPath())));
        // <!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_JQUERY_FLOT_RESIZE).getPath())));
        // <!-- FLOT PIE PLUGIN - also used to draw donut charts -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_JQUERY_FLOT_PIE).getPath())));
        try {
