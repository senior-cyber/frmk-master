package com.senior.cyber.frmk.html.pages.chart;
...
public class FlotPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("img_user_2", new AdminLTEResourceReference("/dist/img/user2-160x160.jpg")));
        add(new Image("img_user_3", new AdminLTEResourceReference("/dist/img/user3-128x128.jpg")));
        add(new Image("img_user_8", new AdminLTEResourceReference("/dist/img/user8-128x128.jpg")));
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- FLOT CHARTS -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_JQUERY_FLOT)));
        // <!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_JQUERY_FLOT_RESIZE)));
        // <!-- FLOT PIE PLUGIN - also used to draw donut charts -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_JQUERY_FLOT_PIE)));
        try {
