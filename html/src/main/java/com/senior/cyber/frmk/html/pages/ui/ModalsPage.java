...
public class ModalsPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- SweetAlert2 -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_SWEET_ALERT_BOOTSTRAP)));
        // <!-- Toastr -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_TOASTR)));
        // <!-- AdminLTE App -->
