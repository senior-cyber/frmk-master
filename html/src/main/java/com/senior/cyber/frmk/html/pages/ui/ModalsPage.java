...
public class ModalsPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- SweetAlert2 -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_SWEET_ALERT_BOOTSTRAP).getPath())));
        // <!-- Toastr -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_TOASTR).getPath())));
        // <!-- AdminLTE App -->
