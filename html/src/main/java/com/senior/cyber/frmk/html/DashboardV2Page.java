...
public class DashboardV2Page extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new BookmarkablePageLink<>("pages/examples/invoice.html_1", InvoicePage.class));
        add(new BookmarkablePageLink<>("pages/examples/invoice.html_2", InvoicePage.class));
        add(new BookmarkablePageLink<>("pages/examples/invoice.html_3", InvoicePage.class));
        add(new BookmarkablePageLink<>("pages/examples/invoice.html_4", InvoicePage.class));
        add(new BookmarkablePageLink<>("pages/examples/invoice.html_5", InvoicePage.class));
        add(new BookmarkablePageLink<>("pages/examples/invoice.html_6", InvoicePage.class));
        add(new BookmarkablePageLink<>("pages/examples/invoice.html_7", InvoicePage.class));
        add(new BookmarkablePageLink<>("pages/examples/invoice.html_8", InvoicePage.class));
        ...
        add(new Image("img_logo_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_LOGO)));
        ...
        add(new Image("img_user_2_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_2)));
        add(new Image("img_user_2_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_2)));
        ...
        add(new Image("img_user_5_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_5)));
        add(new Image("img_user_5_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_5)));
        add(new Image("img_user_6_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_6)));
        add(new Image("img_user_6_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_6)));
        ...
        add(new Image("img_user_8_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("img_user_8_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("img_user_8_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("img_default_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_DEFAULT)));
        add(new Image("img_default_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_DEFAULT)));
        add(new Image("img_default_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_DEFAULT)));
        add(new Image("img_default_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_DEFAULT)));
    }
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- overlayScrollbars -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_OVERLAY_SCROLL_BAR)));
        // <!-- Theme style -->
        ...
        // <!-- jQuery Mapael -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_JQUERY_MOUSEWHEEL)));
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_RAPHAEL)));
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_JQUERY_MAPAEL)));
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_JQUERY_MAPAEL_USA)));
        // <!-- ChartJS -->
        ...
        try {
            ...
            response.render(OnDomReadyHeaderItem.forScript(FileUtils.readFileToString(new File(properties.getAdminLTE(), AdminLTEResourceReference.JS_DIST_DASHBOARD_2), StandardCharsets.UTF_8)));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
