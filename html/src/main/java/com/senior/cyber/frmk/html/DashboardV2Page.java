...
public class DashboardV2Page extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new BookmarkablePageLink<>("simple.html_1", com.senior.cyber.frmk.html.pages.search.SimplePage.class));
        ...
        add(new BookmarkablePageLink<>("general.html_2", GeneralPage.class));
        ...
        add(new BookmarkablePageLink<>("simple.html_2", SimplePage.class));
        ...
        add(new BookmarkablePageLink<>("invoice.html_2", InvoicePage.class));
        add(new BookmarkablePageLink<>("invoice.html_3", InvoicePage.class));
        add(new BookmarkablePageLink<>("invoice.html_4", InvoicePage.class));
        add(new BookmarkablePageLink<>("invoice.html_5", InvoicePage.class));
        add(new BookmarkablePageLink<>("invoice.html_6", InvoicePage.class));
        add(new BookmarkablePageLink<>("invoice.html_7", InvoicePage.class));
        add(new BookmarkablePageLink<>("invoice.html_8", InvoicePage.class));
        ...
        add(new Image("user2-160x160.jpg_2", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_2).getPath())));
        ...
        add(new Image("user5-128x128.jpg_2", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_5).getPath())));
        ...
        add(new Image("user6-128x128.jpg_2", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_6).getPath())));
        ...
        add(new Image("user8-128x128.jpg_3", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_8).getPath())));
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- jQuery Mapael -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_JQUERY_MOUSEWHEEL).getPath())));

        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_RAPHAEL).getPath())));
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_JQUERY_MAPAEL).getPath())));
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_JQUERY_MAPAEL_USA).getPath())));
        // <!-- ChartJS -->
