...
public class DashboardV2Page extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("user2-160x160.jpg_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_2)));
        ...
        add(new Image("user5-128x128.jpg_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_5)));
        add(new Image("user6-128x128.jpg_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_6)));
        add(new Image("user6-128x128.jpg_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_6)));
        ...
        add(new Image("user8-128x128.jpg_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
