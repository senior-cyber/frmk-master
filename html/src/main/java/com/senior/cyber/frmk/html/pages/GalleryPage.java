...
public class GalleryPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- Ekko Lightbox -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_LIGHT_BOX).getPath())));
        // <!-- Ionicons -->
        ...
        // <!-- Ekko Lightbox -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_LIGHT_BOX).getPath())));
        // <!-- AdminLTE App -->
        ...
        // <!-- Filterizr-->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_JQUERY_FILTER).getPath())));
        try {
