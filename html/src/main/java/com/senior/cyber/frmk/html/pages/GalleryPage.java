...
public class GalleryPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- Ekko Lightbox -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_LIGHT_BOX)));
        // <!-- Ionicons -->
        ...
        // <!-- Ekko Lightbox -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_LIGHT_BOX)));
        // <!-- AdminLTE App -->
        ...
        // <!-- Filterizr-->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_JQUERY_FILTER)));
        try {
