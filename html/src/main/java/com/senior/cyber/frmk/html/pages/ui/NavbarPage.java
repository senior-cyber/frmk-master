package com.senior.cyber.frmk.html.pages.ui;
...
public class NavbarPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(index3_4);
        BookmarkablePageLink<Void> index3_5 = new BookmarkablePageLink<>("index3.html_5", DashboardV3Page.class);
        add(index3_5);
        BookmarkablePageLink<Void> index3_6 = new BookmarkablePageLink<>("index3.html_6", DashboardV3Page.class);
        add(index3_6);
        BookmarkablePageLink<Void> index3_7 = new BookmarkablePageLink<>("index3.html_7", DashboardV3Page.class);
        add(index3_7);
        BookmarkablePageLink<Void> index3_8 = new BookmarkablePageLink<>("index3.html_8", DashboardV3Page.class);
        add(index3_8);
        ...
        add(new Image("img_user_8_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("img_user_8_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("img_user_8_6", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("img_user_8_7", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- SweetAlert2 -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_SWEET_ALERT_BOOTSTRAP)));
        // <!-- Toastr -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_TOASTR)));
        // <!-- Theme style -->
