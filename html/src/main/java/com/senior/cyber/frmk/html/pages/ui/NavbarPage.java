...
public class NavbarPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("user8-128x128.jpg_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("user8-128x128.jpg_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("user8-128x128.jpg_6", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
        add(new Image("user8-128x128.jpg_7", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_8)));
