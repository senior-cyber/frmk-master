...
public class NavbarPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(index3_8);
        BookmarkablePageLink<Void> index3_9 = new BookmarkablePageLink<>("index3.html_9", DashboardV3Page.class);
        add(index3_9);
        ...
        add(new Image("user8-128x128.jpg_4", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_8).getPath())));
        add(new Image("user8-128x128.jpg_5", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_8).getPath())));
        add(new Image("user8-128x128.jpg_6", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_8).getPath())));
        add(new Image("user8-128x128.jpg_7", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_8).getPath())));
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- SweetAlert2 -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_SWEET_ALERT_BOOTSTRAP).getPath())));
        // <!-- Toastr -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_TOASTR).getPath())));
        // <!-- Theme style -->
