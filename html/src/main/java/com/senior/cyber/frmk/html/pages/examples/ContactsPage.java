...
public class ContactsPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("user2-160x160.jpg_3", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_2).getPath())));
        add(new Image("user2-160x160.jpg_4", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_USER_2).getPath())));
