...
public class ContactsPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("img_user_2_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_2)));
        add(new Image("img_user_2_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_2)));
