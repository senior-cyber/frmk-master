...
public class ContactsPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("user2-160x160.jpg_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_2)));
        add(new Image("user2-160x160.jpg_4", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_USER_2)));
