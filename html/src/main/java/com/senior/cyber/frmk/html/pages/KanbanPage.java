...
public class KanbanPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- Ekko Lightbox -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, "/plugins/ekko-lightbox/ekko-lightbox.css").getPath())));
        ...
        // <!-- Ekko Lightbox -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, "/plugins/ekko-lightbox/ekko-lightbox.min.js").getPath())));
        // <!-- AdminLTE App -->
        ...
        // <!-- Filterizr-->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, "/plugins/filterizr/jquery.filterizr.min.js").getPath())));
    }
