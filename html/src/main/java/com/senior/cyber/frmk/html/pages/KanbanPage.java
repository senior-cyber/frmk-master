...
public class KanbanPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- Ekko Lightbox -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference("/plugins/ekko-lightbox/ekko-lightbox.css")));
        ...
        // <!-- Ekko Lightbox -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference("/plugins/ekko-lightbox/ekko-lightbox.min.js")));
        // <!-- AdminLTE App -->
        ...
        // <!-- Filterizr-->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference("/plugins/filterizr/jquery.filterizr.min.js")));
