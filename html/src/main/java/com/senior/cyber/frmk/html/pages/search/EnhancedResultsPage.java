...
public class EnhancedResultsPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- Select2 -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference("/plugins/select2/css/select2.min.css")));
        // <!-- Theme style -->
        ...
        // <!-- Select2 -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference("/plugins/select2/js/select2.full.min.js")));
        // <!-- AdminLTE App -->
