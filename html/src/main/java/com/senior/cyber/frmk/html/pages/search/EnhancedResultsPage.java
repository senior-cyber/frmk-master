package com.senior.cyber.frmk.html.pages.search;
...
public class EnhancedResultsPage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        WebMarkupContainer form = new WebMarkupContainer("enhanced-results.html_1");
        form.add(AttributeModifier.replace("action", urlFor(EnhancedResultsPage.class, null).toString()));
        add(form);
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- Select2 -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, "/plugins/select2/css/select2.min.css").getPath())));
        // <!-- Theme style -->
        ...
        // <!-- Select2 -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, "/plugins/select2/js/select2.full.min.js").getPath())));
        // <!-- AdminLTE App -->
