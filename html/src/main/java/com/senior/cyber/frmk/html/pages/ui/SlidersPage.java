...
public class SlidersPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- Ion Slider -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_RANGE_SLIDER).getPath())));
        // <!-- bootstrap slider -->
        response.render(CssHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.CSS_SLIDER_BOOTSTRAP).getPath())));
        // <!-- Theme style -->
        ...
        // <!-- Ion Slider -->
        response.render(JavaScriptHeaderItem.forReference(new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.JS_RANGE_SLIDER_ION).getPath())));
        // <!-- Bootstrap slider -->
