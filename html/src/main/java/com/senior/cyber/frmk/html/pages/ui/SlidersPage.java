...
public class SlidersPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        // <!-- Ion Slider -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_RANGE_SLIDER)));
        // <!-- bootstrap slider -->
        response.render(CssHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.CSS_SLIDER_BOOTSTRAP)));
        // <!-- Theme style -->
        ...
        // <!-- Ion Slider -->
        response.render(JavaScriptHeaderItem.forReference(new AdminLTEResourceReference(AdminLTEResourceReference.JS_RANGE_SLIDER_ION)));
        // <!-- Bootstrap slider -->
