...
public class ECommercePage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("prod-1.jpg_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_1)));
        add(new Image("prod-1.jpg_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_1)));
        add(new Image("prod-2.jpg_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_2)));
        add(new Image("prod-3.jpg_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_3)));
        add(new Image("prod-4.jpg_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_4)));
        add(new Image("prod-5.jpg_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_5)));
    }
