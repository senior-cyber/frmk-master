...
public class ECommercePage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("img_prod_1_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_1)));
        add(new Image("img_prod_1_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_1)));
        add(new Image("img_prod_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_2)));
        add(new Image("img_prod_3", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_3)));
        add(new Image("img_prod_4_1", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_4)));
        add(new Image("img_prod_4_2", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_4)));
//        add(new Image("img_prod_5", new AdminLTEResourceReference(AdminLTEResourceReference.IMG_PRD_5)));
    }
