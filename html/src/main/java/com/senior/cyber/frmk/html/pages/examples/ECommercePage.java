...
public class ECommercePage extends WebPage {
    ...
    protected void onInitialize() {
        ...
        add(new Image("prod-1.jpg_1", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PRD_1).getPath())));
        add(new Image("prod-1.jpg_2", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PRD_1).getPath())));
        add(new Image("prod-2.jpg_1", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PRD_2).getPath())));
        add(new Image("prod-3.jpg_1", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PRD_3).getPath())));
        add(new Image("prod-4.jpg_1", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PRD_4).getPath())));
        add(new Image("prod-5.jpg_1", new FileSystemResourceReference(new File(adminLte, AdminLTEResourceReference.IMG_PRD_5).getPath())));
    }
