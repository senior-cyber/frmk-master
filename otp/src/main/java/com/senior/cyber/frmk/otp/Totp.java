package com.senior.cyber.frmk.otp;

import com.senior.cyber.frmk.otp.internal.*;
...
public class Totp {
    ...
    public String uri(String name) {
        return String.format("otpauth://totp/%s?secret=%s", name, this.secret);
    }

    public String uri(String title, String login) {
        return String.format("otpauth://totp/%s(%s)?secret=%s", title, login, this.secret);
    }
