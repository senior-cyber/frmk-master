...
public class MemoryMultipleChoiceProvider<Id, Label> extends IMultipleChoiceProvider<Id, Label> {

    private final List<Option> options;

    public MemoryMultipleChoiceProvider(
