...
public class Select2FullMinJS extends FileSystemResourceReference {

    public static final Select2FullMinJS INSTANCE = new Select2FullMinJS();

    public Select2FullMinJS() {
        super(new File(((LTEAdminProperties) WebApplication.get()).getWebUiProperties().getAdminLte(), AdminLTEResourceReference.JS_SELECT_2).getPath());
    }
