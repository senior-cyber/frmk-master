...
public class StackedBarChart extends WebComponent {
    ...
    public StackedBarChart(String id, IModel<StackedBarData> model) {
        super(id);
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        String option = "{'responsive':true,'maintainAspectRatio':false,'scales':{'xAxes':[{'stacked':true,}],'yAxes':[{'stacked':true}]}}";
    ...
    public static class StackedBarData implements Serializable {
        ...
        private List<StackedBarItem> datasets = new LinkedList<>();
        ...
        public List<StackedBarItem> getDatasets() {
            return datasets;
        }
