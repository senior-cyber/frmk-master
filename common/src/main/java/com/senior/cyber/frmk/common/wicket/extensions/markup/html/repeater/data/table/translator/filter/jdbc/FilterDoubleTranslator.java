...
public class FilterDoubleTranslator implements IFilterTranslator<Double> {
    ...
    @Override
    public JdbcFilterValue renderToFilter(String key, String column, Operator operator, Double firstOperand, Double secondOperand) {
