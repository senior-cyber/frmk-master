...
public class AreaChart extends WebComponent {
    ...
    public AreaChart(String id, IModel<AreaData> model) {
        super(id);
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        String option = "{'maintainAspectRatio':false,'responsive':true,'legend':{'display':false},'scales':{'xAxes':[{'gridLines':{'display':false}}],'yAxes':[{'gridLines':{'display':false}}]}}";
    ...
    public static class AreaData implements Serializable {
        ...
        private List<AreaItem> datasets = new LinkedList<>();

        public List<String> getLabels() {
            return labels;
        }

        public List<AreaItem> getDatasets() {
            return datasets;
        }
