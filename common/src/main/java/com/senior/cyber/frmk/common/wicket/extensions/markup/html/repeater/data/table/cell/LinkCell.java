...
public class LinkCell extends ItemPanel {
    ...
    public LinkCell(Class<? extends Page> page, PageParameters parameters, byte v, String pattern) {
        this(page, parameters, Model.of(ReadOnlyView.getFormat(pattern).format(v)));
    }
    ...
    public LinkCell(Class<? extends Page> page, PageParameters parameters, Byte v, String pattern) {
        this(page, parameters, v != null ? Model.of(ReadOnlyView.getFormat(pattern).format(v)) : Model.of(""));
    }
