...
public class FilterDateTranslator implements IFilterTranslator<Date> {
    ...
    @Override
    public JdbcFilterValue renderToFilter(String key, String column, Operator operator, Date firstOperand, Date secondOperand) {
