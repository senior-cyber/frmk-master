...
public class FilterTimeTranslator implements IFilterTranslator<Time> {
    ...
    @Override
    public JdbcFilterValue renderToFilter(String key, String column, Operator operator, Time firstOperand, Time secondOperand) {
