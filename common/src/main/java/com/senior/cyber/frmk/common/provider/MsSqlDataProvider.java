...
public abstract class MsSqlDataProvider extends QueryDataProvider {

    public MsSqlDataProvider() {
    }

    public MsSqlDataProvider(String from) {
        super(from);
    }
    ...
    protected QueryBuilder buildQuery(Map<String, Object> params, String orderBy) {
        ...
        QueryBuilder builder = new MsSqlQueryBuilder();
    ...
    protected static class MsSqlQueryBuilder extends QueryBuilder {
        ...
        public String toCountSQL(String id) {
            ...
            if (this.groupBy == null || this.groupBy.isEmpty()) {
                ...
                builder.append("SELECT ");
                builder.append("count(" + this.groupBy + ") over()");
                builder.append(" FROM ");
                builder.append(this.from).append(" ");
                builder.append(StringUtils.join(this.join, " "));
                if (!this.where.isEmpty()) {
