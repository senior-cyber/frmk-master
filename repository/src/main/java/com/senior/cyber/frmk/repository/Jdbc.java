...
public class Jdbc {
    ...
    public String insert(String table, Map<String, Object> values, Map<String, Object> systems) throws SQLException {
        ...
        selectQuery.addWhere("`table` = :table", table);
...
//                }
                ...
                for (Map.Entry<String, Object> attr : values.entrySet()) {
                    insertQuery.addValueInternal(AFTER + "_" + attr.getKey() + " = :" + AFTER + "_" + attr.getKey(), attr.getValue());
                }
                insertQuery.addValueInternal(this.userPk + " = :" + this.userPk, systems.get(this.userPk));
                insertQuery.addValue("dt_when = :dt_when", new Date());
                insertQuery.addValue("op = :op", "INSERT");
                insertQuery.addValueInternal(pk + " = :" + pk, id);
                insertQuery.addValue("level = :level", install.getLevel());
            ...
            for (Map.Entry<String, Object> attr : values.entrySet()) {
                insertQuery.addValueInternal(attr.getKey() + " = :" + attr.getKey(), attr.getValue());
            }
            insertQuery.addValueInternal(pk + " = :" + pk, id);
            this.named.update(insertQuery.toSQL(), insertQuery.toParam());
            return null;
...
//            }
            ...
            insertQuery.addValue("op = :op", "INSERT");
            insertQuery.addValue("draft_yes = :draft_yes", 0);
            insertQuery.addValue("draft_no = :draft_no", 0);
            insertQuery.addValue("review_yes = :review_yes", 0);
            insertQuery.addValue("review_no = :review_no", 0);
            insertQuery.addValue("dt_when = :dt_when", new Date());
            this.named.update(insertQuery.toSQL(), insertQuery.toParam());
            ...
            insertQuery.addValueInternal(this.userPk + " = :" + this.userPk, systems.get(this.userPk));
            insertQuery.addValue("dt_when = :dt_when", new Date());
            insertQuery.addValue("yes = :yes", install.getDraftYes());
            insertQuery.addValue("no = :no", install.getDraftNo());
            insertQuery.addValue("op = :op", "INSERT");
            insertQuery.addValueInternal(pk + " = :" + pk, id);
            insertQuery.addValue(draftPk + " = :" + draftPk, taskId);
//            insertQuery.addValue(SYSTEM_TRANSACTION_ID + " = :" + SYSTEM_TRANSACTION_ID, systems.get(SYSTEM_TRANSACTION_ID));
            this.named.update(insertQuery.toSQL(), insertQuery.toParam());
            return taskId;
...
//            }
            ...
            insertQuery.addValue("task_id = :task_id", taskId);
            insertQuery.addValue("`table` = :table", table);
            insertQuery.addValue("action = :action", "APPROVE");
            insertQuery.addValue("op = :op", "INSERT");
            insertQuery.addValue("draft_yes = :draft_yes", 0);
            insertQuery.addValue("draft_no = :draft_no", 0);
            insertQuery.addValue("review_yes = :review_yes", 0);
            ...
            insertQuery.addValueInternal(this.userPk + " = :" + this.userPk, systems.get(this.userPk));
            insertQuery.addValue("dt_when = :dt_when", new Date());
            insertQuery.addValue("yes = :yes", install.getReviewYes());
            insertQuery.addValue("no = :no", install.getReviewNo());
            insertQuery.addValue("op = :op", "INSERT");
            insertQuery.addValueInternal(pk + " = :" + pk, id);
            insertQuery.addValue(reviewPk + " = :" + reviewPk, taskId);
            // insertQuery.addValue(SYSTEM_TRANSACTION_ID + " = :" + SYSTEM_TRANSACTION_ID, systems.get(SYSTEM_TRANSACTION_ID));
            this.named.update(insertQuery.toSQL(), insertQuery.toParam());
            return taskId;
        } else {
...
//                param.put(Engine.SYSTEM_TRANSACTION_ID, systems.get(Engine.SYSTEM_TRANSACTION_ID));
            ...
            for (Map.Entry<String, Object> attr : wheres.entrySet()) {
                deleteQuery.addWhereInternal(attr.getKey() + " = :" + attr.getKey(), attr.getValue());
            }
...
//            }
            ...
            insertQuery.addValue("`table` = :table", table);
            insertQuery.addValue("action = :action", "REVIEW");
            insertQuery.addValue("op = :op", "DELETE");
            insertQuery.addValue("draft_yes = :draft_yes", 0);
            insertQuery.addValue("draft_no = :draft_no", 0);
            insertQuery.addValue("review_yes = :review_yes", 0);
            insertQuery.addValue("review_no = :review_no", 0);
...
//                param.put(Engine.SYSTEM_TRANSACTION_ID, systems.get(Engine.SYSTEM_TRANSACTION_ID));
            ...
            for (Map.Entry<String, Object> attr : values.entrySet()) {
                updateQuery.addValueInternal(attr.getKey() + " = :" + attr.getKey(), attr.getValue());
            }
            for (Map.Entry<String, Object> attr : wheres.entrySet()) {
                updateQuery.addWhereInternal(attr.getKey() + " = :" + attr.getKey(), attr.getValue());
            }
...
//            }
            ...
            insertQuery.addValue("`table` = :table", table);
            insertQuery.addValue("action = :action", "REVIEW");
            insertQuery.addValue("op = :op", "UPDATE");
            insertQuery.addValue("draft_yes = :draft_yes", 0);
            insertQuery.addValue("draft_no = :draft_no", 0);
            insertQuery.addValue("review_yes = :review_yes", 0);
            insertQuery.addValue("review_no = :review_no", 0);
...
//            param.put(SYSTEM_TRANSACTION_ID, systems.get(SYSTEM_TRANSACTION_ID));
    ...
    public void draftReject(String taskId, String reason, Map<String, Object> systems) throws SQLException {
        ...
        selectQuery.addWhere("task_id = :task_id", taskId);
        ...
        selectQuery.addWhere("`table` = :table", task.getTable());
        Install install = this.named.queryForObject(selectQuery.toSQL(), selectQuery.toParam(), Install.class);
        ...
        selectQuery.addWhere(draftPk + " = :" + draftPk, task.getTaskId());
        ...
        insertQuery.addValue(draftPk + " = :" + draftPk, task.getTaskId());
        insertQuery.addValueInternal(this.userPk + " = :" + this.userPk, systems.get(this.userPk));
        insertQuery.addValue("reason = :reason", reason);
        insertQuery.addValue("action = :action", "NO");
        this.named.update(insertQuery.toSQL(), insertQuery.toParam());

        selectQuery = new MySqlSelectQuery(draftSummaryTable);
        selectQuery.addField("COUNT(*)");
        selectQuery.addWhere("action = :action", "NO");
        selectQuery.addWhere(draftPk + " = :" + draftPk, task.getTaskId());
        ...
        updateQuery.addValue("draft_no = :draft_no", runDraftNo);
        updateQuery.addWhere("task_id = :task_id", taskId);
        this.named.update(updateQuery.toSQL(), updateQuery.toParam());
    ...
    public void draftApprove(String taskId, Map<String, Object> systems) throws SQLException {
        ...
        insertQuery.addValue(draftPk + " = :" + draftPk, task.getTaskId());
        insertQuery.addValueInternal(this.userPk + " = :" + this.userPk, systems.get(this.userPk));
        insertQuery.addValue("action = :action", "YES");
        this.named.update(insertQuery.toSQL(), insertQuery.toParam());

        selectQuery = new MySqlSelectQuery(draftSummaryTable);
        selectQuery.addField("COUNT(*)");
        selectQuery.addWhere("action = :action", "YES");
        selectQuery.addWhere(draftPk + " = :" + draftPk, task.getTaskId());
        Integer runDraftYes = this.named.queryForObject(selectQuery.toSQL(), selectQuery.toParam(), int.class);

        UpdateQuery updateQuery = new UpdateQuery(TASK);
        updateQuery.addValue("draft_yes = :draft_yes", runDraftYes);
        updateQuery.addWhere("task_id = :task_id", taskId);
        this.named.update(updateQuery.toSQL(), updateQuery.toParam());
        ...
        if (runDraftYes != null && runDraftYes >= draftYes) {
            ...
            updateQuery.addValue("action = :action", "APPROVE");
            updateQuery.addWhere("task_id = :task_id", taskId);
            this.named.update(updateQuery.toSQL(), updateQuery.toParam());
        }
    }
    ...
    public void reviewReject(String taskId, String reason, Map<String, Object> systems) throws SQLException {
        ...
        selectQuery.addWhere(reviewPk + " = :" + reviewPk, task.getTaskId());
        Map<String, Object> record = null;
        try {
            record = this.named.queryForMap(selectQuery.toSQL(), selectQuery.toParam());
        } catch (EmptyResultDataAccessException e) {
        ...
        insertQuery.addValue(reviewPk + " = :" + reviewPk, task.getTaskId());
        insertQuery.addValueInternal(this.userPk + " = :" + this.userPk, systems.get(this.userPk));
        insertQuery.addValue("reason = :reason", reason);
        insertQuery.addValue("action = :action", "NO");
        this.named.update(insertQuery.toSQL(), insertQuery.toParam());
        ...
        UpdateQuery updateQuery = new UpdateQuery(TASK);
        updateQuery.addValue("review_no = :review_no", runReviewNo);
        updateQuery.addWhere("task_id = :task_id", taskId);
        this.named.update(updateQuery.toSQL(), updateQuery.toParam());
        ...
        if (runReviewNo != null && runReviewNo >= reviewNo) {
            ...
            deleteQuery.addWhere(draftPk + " = :" + draftPk, task.getTaskId());
            this.named.update(deleteQuery.toSQL(), deleteQuery.toParam());
    ...
    public void reviewApprove(String taskId, Map<String, Object> systems) throws SQLException {
        ...
        UpdateQuery updateQuery = new UpdateQuery(TASK);
        updateQuery.addValue("review_yes = :review_yes", runReviewYes);
        updateQuery.addWhere("task_id = :task_id", taskId);
        this.named.update(updateQuery.toSQL(), updateQuery.toParam());
        ...
        if (runReviewYes != null && runReviewYes >= reviewYes) {
            ...
            if ("INSERT".equals(op)) {
                ...
                updateQuery.addWhereInternal(pk + " = :" + pk, record.get(pk));
                for (String intoField : intoFields) {
                    updateQuery.addValueInternal(intoField + " = :" + intoField, from.get(AFTER + "_" + intoField));
                }
                this.named.update(updateQuery.toSQL(), updateQuery.toParam());
            } else if ("DELETE".equals(op)) {
                DeleteQuery deleteQuery = new DeleteQuery(table);
                deleteQuery.addWhereInternal(pk + " = :" + pk, record.get(pk));
                this.named.update(deleteQuery.toSQL(), deleteQuery.toParam());
            }
            ...
            deleteQuery.addWhere(reviewPk + " = :" + reviewPk, task.getTaskId());
            this.named.update(deleteQuery.toSQL(), deleteQuery.toParam());
            ...
            deleteQuery = new DeleteQuery(TASK);
            deleteQuery.addWhere("task_id = :task_id", task.getTaskId());
            this.named.update(deleteQuery.toSQL(), deleteQuery.toParam());
        }
    }
